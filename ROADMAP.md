...
- Use `benchmark-readiness` before execution so missing official runners and endpoint capability gaps are explicit instead of discovered through failed benchmark runs.
